...
class PlayerPage2 extends ConsumerStatefulWidget {
  PlayerPage2({Key? key}) : super(key: key);

  @override
  ConsumerState<PlayerPage2> createState() => _PlayerPageState2();
}

class _PlayerPageState2 extends ConsumerState<PlayerPage2> {
